...
<div id="wrapper">
	...
	<div id="content-wrapper" class="d-flex flex-column">
		...
		<div id="content">
			...
			<form action="/updateAdmin/${updateadmin.id}" method="post"  modelAttribute = "updateadminaccounts" enctype="multipart/form-data" >
				<div class="container">
					<h1>Update Admin</h1>
					<hr>
					...
					<input type="text" value="${updateadmin.id}"  readonly="readonly" placeholder="" name="id" id="id" required>

					<label for="firstName"><b>Name</b></label>
					<input type="text" value="${updateadmin.firstName}" placeholder="Enter Category_Name" name="firstName" id="firstName" required>

					<label for="lastName"><b>Email</b></label>
					<input type="text" value="${updateadmin.lastName}" placeholder="Enter Category_Name" name="lastName" id="lastName" required>

					<label for="username"><b>Phone</b></label>
					<input type="text" value="${updateadmin.username}" placeholder="Enter Category_Name" name="username" id="username" required>

					<label for="password"><b>Address</b></label>
					<input type="text" value="${updateadmin.password}" placeholder="Enter Category_Name" name="password" id="password" required>

					<label ><b>Image_Admin: </b></label>
					<input type="file" name="file"  />
					<hr>

					<button type="submit" class="registerbtn">Update Admin</button>
				</div>
