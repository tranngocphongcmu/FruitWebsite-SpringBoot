...
<div id="wrapper">
	...
	<div id="content-wrapper" class="d-flex flex-column">
		...
		<div id="content">
			...
			<form action="addUser" method="post"  modelAttribute="userAdmin" >
				<div class="container">
					<h1>Add User</h1>
					<hr>
...
<%--					<input type="text" placeholder="Enter Category_ID" name="id" id="id" required>--%>
					...
					<input type="text" placeholder="Enter User_Name" name="name" id="name" required>
					<hr>

					<label for="email"><b>email</b></label>
					<input type="text" placeholder="Enter User_email" name="email" id="email" required>
					<hr>

					<label for="phone"><b>phone</b></label>
					<input type="text" placeholder="Enter User_password" name="phone" id="phone" required>
					<hr>

					<label for="address"><b>address</b></label>
					<input type="text" placeholder="Enter User_address" name="address" id="address" required>
					<hr>


					<label for="password"><b>password</b></label>
					<input type="text" placeholder="Enter User_password" name="password" id="password" required>
					<hr>
